...
class PatientServiceStub:
    ...
    UpdateMedications: _grpc.UnaryUnaryMultiCallable[_patient_pb2.UpdateMedicationsReq, _patient_pb2.UpdateMedicationsRes]
...
class PatientServiceAsyncStub(PatientServiceStub):
    ...
    UpdateMedications: _aio.UnaryUnaryMultiCallable[_patient_pb2.UpdateMedicationsReq, _patient_pb2.UpdateMedicationsRes]  # type: ignore[assignment]
...
class PatientServiceServicer(metaclass=_abc_1.ABCMeta):
    ...
    @_abc_1.abstractmethod
    def UpdateMedications(
        self,
        request: _patient_pb2.UpdateMedicationsReq,
        context: _ServicerContext,
    ) -> _typing.Union[_patient_pb2.UpdateMedicationsRes, _abc.Awaitable[_patient_pb2.UpdateMedicationsRes]]: ...
