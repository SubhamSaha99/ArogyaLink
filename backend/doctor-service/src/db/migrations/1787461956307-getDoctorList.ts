...
export class GetDoctorList1787461956307 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<void> {

        await queryRunner.query(`
            CREATE OR REPLACE FUNCTION get_doctor_list(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            DROP FUNCTION IF EXISTS get_doctor_list(INTEGER, INTEGER, VARCHAR, INTEGER, INTEGER);
        `);
    }
