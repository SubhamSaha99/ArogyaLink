...
/**
 * Validation schema matching backend PatientRegDto:
 * - email: valid email
...
const patientRegistrationSchema = Yup.object().shape({
  ...
  mobile: Yup.string()
    .trim()
    .matches(/^\+[1-9]{1}[0-9]{3,14}$/, "Invalid Mobile Number (e.g. +919876543210)")
  ...
  agreeTerms: Yup.boolean().oneOf(
    [true],
    "You must agree to the ArogyaLink health record data terms and privacy compliance.",
  ),
});

export interface PatientRegFormValues {
  email: string;
  mobile: string;
  firstName: string;
  middleName: string;
...
export const PatientRegisterPage: React.FC = () => {
  ...
  const formik = useFormik<PatientRegFormValues>({
    initialValues: {
      email: "",
      mobile: "+91",
      firstName: "",
    ...
    onSubmit: async (values, { setSubmitting }) => {
      ...
      try {
        ...
        const response = await callApi(
          API_ROUTES.patientRegistration,
          payload,
          "POST",
        );
      ...
      <div className={themeStyles.auth.card}>
        ...
        <div className={themeStyles.auth.heroCol}>
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div className="space-y-2">
              ...
              <p className={themeStyles.typography.bodyWhite}>
                Create your verified patient health record to automatically unify
                prescriptions, lab tests, and hospital discharge summaries into one secure vault.
              </p>
            </div>
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-800/60 border border-slate-700/60">
                ...
                <div className="text-xs">
                  <span className="font-bold text-white block">Automated Record Linking</span>
                  <span className="text-slate-400 text-[11px]">Connect hospital visits and diagnostics seamlessly</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-800/60 border border-slate-700/60">
                ...
                <div className="text-xs">
                  <span className="font-bold text-white block">Emergency Allergy Registry</span>
                  <span className="text-slate-400 text-[11px]">Keep doctors alerted during critical emergency care</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-800/60 border border-slate-700/60">
                ...
                <div className="text-xs">
                  <span className="font-bold text-white block">Complete Privacy & Control</span>
                  <span className="text-slate-400 text-[11px]">Your data is 100% encrypted & consent-driven</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-slate-800 flex items-center justify-between text-[11px] text-slate-400 relative z-10">
            ...
            <span className="font-mono text-emerald-400 font-bold">ABDM & HIPAA Ready</span>
          </div>
        </div>
            ...
            <div className="space-y-6 text-center py-4 animate-in fade-in">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 text-xs text-slate-600 text-left space-y-1.5 max-w-md mx-auto">
                ...
                <p className={themeStyles.typography.muted}>
                  Your account is active. You can now log in to review, manage, and share your consolidated medical histories.
                </p>
              </div>
            ...
            <div>
              <div className="space-y-2 mb-6">
                ...
                <p className={themeStyles.typography.subtext}>
                  Register your personal health vault to access unified medical records.
                </p>
              </div>
              ...
              <form onSubmit={formik.handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="flex items-start gap-2 cursor-pointer text-xs text-slate-600">
                    ...
                    />
                    <span>
                      I agree to the ArogyaLink National Health Data Terms, Privacy Policy, and ABDM consent-driven data storage guidelines.
                    </span>
                  </label>
